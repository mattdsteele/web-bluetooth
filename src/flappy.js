...
const makeGame = (el) => {
  ...
  var mainState = {
    preload: function() { 
      ...
      game.load.image('bird', 'flap/assets/ccc.png'); 
    ...
    create: function() { 
      ...
      this.labelCadence = game.add.text(20, 60, '0',
        { font: "30px Arial", fill: "#ffffff" });   
    ...
    pause() {
      game.paused = true;
      if (!this.pausedText) {
        this.pausedText = game.add.text(30, game.world.centerY - 50, 'PEDAL FASTER',
